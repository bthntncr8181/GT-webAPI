...
public class EmployeeService:IEmployeeService
{
    ...
    public async Task<IResults> Register(EmployeeRegisterDTO registerDto)
    {
        ...
        var valResult = FluentValidationTool.ValidateModelWithKeyResult<EmployeeRegisterDTO>(new EmployeeRegisterValidator(), registerDto);
        ...
        var employee = await _service.GetByIdAsync((x => x.Mail.ToLower() == mail && !x.IsDeleted)); //get by mail eklenecek
