...
namespace GTBack.Repository.Migrations
{
    ...
    [Migration("20231029130939_nULLABLE_MENU")]
    partial class nULLABLE_MENU
    {
            ...
            modelBuilder.Entity("GTBack.Core.Entities.Restourant.Menu", b =>
                {
                    b.HasOne("GTBack.Core.Entities.Restourant.RestoCompany", "RestoCompany")
                        .WithOne("Menu")
                        .HasForeignKey("GTBack.Core.Entities.Restourant.Menu", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
