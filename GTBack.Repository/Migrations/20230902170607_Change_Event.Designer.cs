...
namespace GTBack.Repository.Migrations
{
    ...
    [Migration("20230902170607_Change_Event")]
    partial class Change_Event
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GTBack.Core.Entities.EventTypeCompanyRelation", b =>
                {
                    ...
                    b.ToTable("EventTypeCompanyRelation");
                });
            ...
            modelBuilder.Entity("GTBack.Core.Entities.SpecialAttributeRelation", b =>
                {
                    ...
                    b.ToTable("SpecialAttributeRelation");
                });
            ...
            modelBuilder.Entity("GTBack.Core.Entities.User", b =>
                {
                    b.HasOne("GTBack.Core.Entities.Company", null)
                        .WithMany("User")
                        .HasForeignKey("CompanyId");
                });
